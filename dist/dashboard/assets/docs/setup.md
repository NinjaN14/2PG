...
1) `Fork` the [Nexuz Repo](https://github.com/Halo/Nexuz), or download it
...
```
{
    ...
    "api": {
        "url": "https://nexuz.glitch.me/api", // used for xp cards etc.
    ...
    "webapp": {
        "url": "https://nexuz.glitch.me", // the URL of the dashboard
